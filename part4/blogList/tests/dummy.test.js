...
describe('FAVOURITE BLOG', () => {
  ...
  test('When list has cero Likes', () => {
    const result = listHelper.favoriteBlog(listWithCeroLikes)
...
describe('TOTAL LIKES', () => {
  ...
  test('When list has cero likes', () => {
    const result = listHelper.totalLikes(listWithCeroLikes)
...
describe('MOST BLOGS', () => {
  const bigListOfBlogs = [
    ...
    {
      _id: '5a422bc61b54a676234d17fc',
      title: 'React Native, how to use it?',
      author: 'Lautaro N. Ayosa',
      url: 'http://blog.cleancoder.com/uncle-bob/2016/05/01/TypeWars.html',
      likes: 2,
      __v: 0
    }
